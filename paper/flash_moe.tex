...
Figure~\ref{fig:breakdown} shows the average time budget per layer at the final 2-bit + F\_NOCACHE configuration.
...
\addplot+[draw=blue!80,fill=blue!40] coordinates {(1.49,1)};
\addplot+[draw=red!80,fill=red!40] coordinates {(0.87,1)};
\addplot+[draw=orange!80,fill=orange!50] coordinates {(0.45,1)};
\addplot+[draw=green!70!black,fill=green!30] coordinates {(0.27,1)};
\addplot+[draw=gray!80,fill=gray!30] coordinates {(0.06,1)};
\legend{Expert I/O (1.49), CMD1 wait (0.87), CMD2 wait (0.45), CPU attn (0.27), Other (0.06)}
\end{axis}
\end{tikzpicture}
\caption{Per-layer time breakdown for 2-bit + F\_NOCACHE configuration. Total: 3.14\,ms/layer $\times$ 60 layers = 188\,ms/token $\approx$ 5.3\,tok/s. Expert I/O from NVMe is the dominant cost.}
\label{fig:breakdown}
\end{figure}
